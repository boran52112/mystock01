...
3. KDJ(K/D值)轉折分析與MACD柱狀體動能變化：根據理論...，所以...
4. 布林通道：根據...，所以...
5. 技術指標分析：超買、超賣、黃金交叉、死亡交叉、背離...
6. 量價背離與動能支撐關係：量增價漲（健康）、量縮價漲（背離）、量增價跌（出貨）..分辨趨勢的「真偽」。量能判斷大戶到底是在買還是在賣
7. 道氏理論：根據理論來判斷趨勢(根據數據說明是頭頭高或是頭頭低或是盤整等等)...，所以...
8. 波浪理論：預判目前處於行情的前、中、後段，幫助你判斷「獲利空間」還有多少......
9. 型態學：透過圖形（如 W 底、頭肩頂、三角形）來預測未來的走勢...
[/區塊1]

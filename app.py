    ...
    if st.session_state.stock_data is not None:
        ...
        if st.button(f"🚀 啟動 {current_id} AI 深度診斷"):
            with st.spinner("偵探正在排版專業報告..."):
                ...
                prompt = f"""你是台股 AI 偵探，請依照針對每一項內容對數據進行繁體中文診斷，並給予一段詳細的教學內容，說明為何這樣判斷。
禁止輸出英文思考過程。請直接將內容填入標籤。區塊二的矛盾與整合，請根據區塊一的9項技術指標，有些互相支持呼應，有些互相矛盾，請將所有的情況逐一討論，並進行教學說明應該如何看待這些結果
